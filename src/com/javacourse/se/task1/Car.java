...
public class Car {
  ...
  public Car(String brand, String model, int year, String color, int engineVolume,
      String engineType, String transmissionType, boolean navi, boolean climateControl,
      boolean airBags, int trunkVolume, double length, double weight, int mileage, int price) {
    this.brand = brand;
    this.model = model;
    this.year = year;
    this.color = color;
