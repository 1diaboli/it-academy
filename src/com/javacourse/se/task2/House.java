...
public class House {
  ...
  public House(String street, int houseNumber, int houseYear, int houseMonth, String houseMaterial,
      boolean electricity, boolean gas, boolean water, double length, double width, double height) {
    this.street = street;
  ...
  public void communications() {
    if (electricity && gas && water) {
      ...
      System.out.println("В доме нет газа");
        ...
        System.out.println("В доме нет никаких коммуникаций");
    }
  }
